...
class QuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Setting list of question from SetData object class
        ...
        submit.setOnClickListener {
            if (selectedOption != 0) {
                ...
                if (selectedOption != question.correct_ans) {
                    ...
                    //If answer is wrong color will change to red
                ...
                //If all question are over FINISH test button will appear.
                ...
                //If more questions are there than next question will come by calling *setQuestion* fun
                when {
                    currentPosition <= questionList!!.size -> {
                        setQuestion()
                    }

                    //If all question are finished than next activity is called.
                    else -> {
    ...
    private fun setQuestion() {
        ...
        //Getting QuestionList[length-1] element in question or first question
        val question = questionList!![currentPosition - 1]
        setOptionStyle()


        /*
        Setting progress bar and progress text according to questions answered and
        questions left
         */
    ...
    /*
    Used to set color of option depending on weather they are right or wrong
    by option number
     */
    ...
    //Setting text color of all options present in question
    ...
    //changing style of selected option to show this option is selected
